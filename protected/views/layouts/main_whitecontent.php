    ...
    <div id="outer">
        ...
        <div id="head" class="clearfix">
            ...
            <div id="head_floatingleft50">
                <div class="text salsa">Die Plattform für Lehrer und ihre Schüler</div>
            </div>
               ...
               if(Yii::app()->user->isGuest){ 
                    ...
                    echo "<div class='floatright'>";                   
                        $this->widget('bootstrap.widgets.TbNav', array(
                            ...
                            'items' => array(array('label'=>Yii::app()->user->data()->profile->firstname,'title'=> 'Userrolle: ' . Yii::app()->user->roles . ' | ID: ' . Yii::app()->user->id,'items' => array(
