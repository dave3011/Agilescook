   ...
   function updateStage(){
    ...
    function loadMaterials(stageId, hotspots){
        ...
        $.ajax({
                url: 'materials/' + stageId + '_umamaterials' + hotspots + '.html', 
        ...
        $.ajax({
                url: 'materials/' + stageId + '_ownmaterials.html', 
                success: function(data) {
                    $own.html(data);  
                }
            }).error(function(){
        ...
        $.ajax({
                url: 'materials/' + stageId + '_partnermaterials.html', 
                success: function(data) {
                    $partner.html(data);  
                }
            }).error(function(){
   ...
   $(document).ready(function() {
       ...
       /* Toggle Panel LEFT */
        ...
        $('#sharenowbutton').on('click', function(){   
            ...
            $('#gotoshared').show();        
            $('#gotosharedbutton').attr('href', 'kommunikation.php' +lessondetails + '&materiallist4share=' + materiallist4share); 
        });
    ...
    success: function() 
    {
        ...
        $('#ownmaterials').show();
        $('#filterown').prop('checked', true);
        $('#ownmaterials').prepend("<div class='material material_active own'><h5>" + filename + "</h5><div class='detailinfo show'><p></p><a class='addtolesson' data-file='" + filename + "'>Verwenden</a>&nbsp;<a class='addtoshare' data-file='" + filename + "'>Teilen</a>&nbsp;<a class='play' target='_blank' href='uploads/" + filename + "'>Ansehen</a></div></div>");
    },
