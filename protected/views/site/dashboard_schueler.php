            ...
            <div id="container"> 
                ...
                <div class="kachel rot widget">
                    ...
                    <?php $this->widget('zii.widgets.CListView', array(
                        	...
                        	'itemView'=>'_singleclassschueler',
                            'enablePagination'=>false,
                            'summaryText'=>false
                        )); ?>
                    </div> 
                    <div class="kachelfoot">
                        <?php echo CHtml::link('Zur Klassenübersicht ...<span class="scookicons">&#58942;</span>', $this->createUrl('//klasse'), array());?>
                    </div>                    
                </div>
                ...
                <div class="kachel rot">
                    <div class="kachelhead">Lehrerwitze</div>
                    <div class="kachelcontent">
                        <p id="joke">
                       
                        <?php 
                                $this->renderPartial('/joke/_joke', array(
                                   'joke'=>$joke
                                )                               
                                );
                        ?>
                        ...
                        <p>
                            <?php
                                ...
                                echo "<b>> " . CHtml::ajaxLink('Noch einen', array('joke/getJoke'), array ('update'=>'#joke'), array('class'=>'jokelink')) . "</b>";
                            ?>
                        </p>
                    </div>                  
                </div>
